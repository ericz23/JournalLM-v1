...
export default function NarrativeSnapshot({ content, weekStart, weekEnd, loading }: Props) {
  return (
    <div className="col-span-full relative overflow-hidden rounded-xl border border-[var(--color-brand-accent)]/20 bg-gradient-to-br from-[var(--color-brand-accent)]/[0.08] via-[var(--color-brand-surface)] to-[var(--color-brand-surface)] p-6">
      ...
      <div className="relative mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-brand-accent)]/15">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
